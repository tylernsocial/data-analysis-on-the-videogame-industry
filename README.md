...
### Tools & Technologies
Tableau and Python (Google Colab)
...
Predicting future game sales using machine learning
Sentiment analysis on game reviews
Studying franchise longevity
Impact of digital distribution/subscriptions
Analysis of post-2016 market trends
